...
<br />
	<div id="print">
		<div style = "margin:10px;">
			<br />
			<img src = "images/log.png" style = "float:left; margin-top:-20px; margin-left:50px;" height = "100px" width = "100px">
			<div style = "float:left; margin-left:50px;">
				<center><label>Centralized Healthcare System</label></center>
				<center><label>Ministry of Health</label></center>
				<center><label>P.O BOX:30016–00100</label></center>
				<center><label>Tel. No.+254-20-2717077</label></center>
