...
<html lang = "en">
	...
	<div class = "navbar navbar-default navbar-fixed-top">
		<img src = "images/log.png" style = "float:left;" height = "55px" /><label class = "navbar-brand">Health Center Patient Management System - Victorias City</label>
	...
	<div id = "footer">
		<label class = "footer-title">&copy; Copyright Patient Health Center Management System 2022</label>
	</div>
	</body>
