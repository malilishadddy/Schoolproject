...
<html lang = "en">
	<head>
		<title>Centralized Health Care System</title>
		<meta charset = "UTF-8">
	...
	<div class = "navbar navbar-default navbar-fixed-top">
		<img src = "images/log.png" style = "float:left;" height = "55px" /><label class = "navbar-brand"> Centralized Health Care System</label>
	...
	<div class = "well">
		...
		<div class = "panel panel-success">
			...
			?>
				...
				<label style = "margin-top:5px; margin-right:5px; float:right;">Birth Cert No: <label class = "text-warning"><?php echo $f['itr_no']?></label></label>
			</div>
	...
	<div id = "footer">
		<label class = "footer-title">&copy; Copyright Centralized Health Care System 2022</label>
	</div>
	</body>
