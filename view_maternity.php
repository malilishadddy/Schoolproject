...
<html lang = "en">
	...
	<div class = "navbar navbar-default navbar-fixed-top">
		<img src = "images/log.png" style = "float:left;" height = "55px" /><label class = "navbar-brand">Centralized Centralized Health System</label>
	...
	<div id = "footer">
		<label class = "footer-title">&copy; Copyright Health Center Patient Record Management System 2022</label>
	</div>
	</body>
